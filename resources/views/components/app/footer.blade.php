        ...
        <div class="lg:flex my-8 lg:items-end lg:justify-between">
            <div class="space-y-4">
                <div class="text-sm space-y-2  text-gray-500">
                    <div>Mechnikova st. 19, office 803, Dnipro, Ukraine</div>
                    <a class="block  text-gray-500" href="">contact@ideadigital.agency</a>
                    <a class="block  text-gray-500" href="">+38 098 560-65-65</a>
                </div>
