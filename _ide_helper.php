 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \A17\Twill\RouteServiceProvider::registerMacros()
        ...
        {
                        return \Illuminate\Routing\Router::moduleShowWithPreview($moduleName, $routePrefix, $controllerName);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Routing\Router::module($slug, $options, $resource_options, $resource);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Routing\Router::singleton($slug, $options, $resource_options, $resource);
        }
                    /**
         * 
         *
...
')
     ...
     */ 
        ...
        {
                        /** @var \App\Services\Schema\SchemaRender $instance */
...
namespace  { 
            ...
            class SchemaSeo extends \App\Facades\Schema {}
